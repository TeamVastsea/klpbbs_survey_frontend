...
export default function SurveyPage({ params }: { params: { id: number } }) {
  ...
  function saveNewQuestion() {
      ...
      condition: newQuestionObject.condition ? JSON.parse(newQuestionObject.condition) : undefined,
      required: newQuestionObject.required,
      answer: newQuestionObject.answer ? JSON.parse(newQuestionObject.answer) : undefined,
    };
