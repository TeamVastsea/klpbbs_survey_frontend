...
export default function QuestionEditor(props: QuestionEditorProps) {
  ...
  return (
    <div ref={ref}>
      ...
      {props.question.type === "SingleChoice" && <SingleChoiceQuestion {...props} value="" setValue={() => {
      }}/>}
      {props.question.type === "MultipleChoice" && <MultipleChoiceQuestion {...props} value="" setValue={() => {
      }}/>}
    </div>
  );
}
