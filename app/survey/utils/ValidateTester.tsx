      ...
      <Card shadow="sm" padding="lg" withBorder>
        <Stack gap="md">
          <Group justify="space-between">
            ...
            <Badge color={allAnswered ? 'green' : 'red'} size="lg">
              {allAnswered ? '已完成' : '未完成'}
            </Badge>
          </Group>
          ...
          <Text size="sm">未回答的必填题：{unansweredQuestions.length} 个</Text>
          <Text size="sm">可见但未回答的问题：{visibleUnanswered.length} 个</Text>
            ...
            >
              <Stack gap="xs">
                <Group justify="space-between">
                  ...
                  <Group gap="xs">
                    <Badge color={visibility[index] ? 'green' : 'gray'} variant="outline">
