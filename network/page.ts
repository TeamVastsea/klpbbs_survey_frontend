...
export class PageNetwork {
  ...
  public static savePage = (page: Page) =>
    baseFetcher<string>('/api/page', "PUT", true, JSON.stringify(page), undefined, false, "application/json")();

  public static newPage = (title: string, survey: number, index: number) =>
    baseFetcher<string>('/api/page', "POST", true, JSON.stringify({title, survey, index}), undefined, false, "application/json")();
}
